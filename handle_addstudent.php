...
if (isset($_POST["submit"])){
    ...
    // insert
    $sql = "INSERT INTO `students` ( `fullname`, `email`, `dob`, `gender`, `photo`, `cv`)
      VALUES ('$fullname','$email','$dob','$gender','$photoname','$cvname')";
...
echo'<a class="btn btn-danger" href="participants.php">BACK</a>';
